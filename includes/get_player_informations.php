...
function get_data(string $data_key, ?int $player_id = null): array {
    ...
    return $GLOBALS["players_data"][$player_id][$data_key] ?? [];
}
 ...
 */
function get_friendships(?int $player_id = null): array {
 ...
 */
function get_unlockables(?int $player_id = null): array {
 ...
 */
function get_books(?int $player_id = null): array {
 ...
 */
function get_fish(?int $player_id = null): array {
 ...
 */
function get_minerals(?int $player_id = null): array {
 ...
 */
function get_artifacts(?int $player_id = null): array {
 ...
 */
function get_enemies_killed(?int $player_id = null): array {
 ...
 */
function get_achievements(?int $player_id = null): array {
 ...
 */
function get_shipped_items(?int $player_id = null): array {
 ...
 */
function get_crafting_recipes(?int $player_id = null): array {
...
function get_farm_animals(): array {
 ...
 */
function get_secret_notes(?int $player_id = null): array {
 ...
 */
function get_locations_visited(?int $player_id = null): array {
 ...
 */
function get_cooking_recipes(?int $player_id = null): array {
 ...
 */
function get_quest_log(?int $player_id = null): array {
 ...
 */
function get_skills(?int $player_id = null): array {
 ...
 */
function get_skills_levels(?int $player_id = null): array {
 ...
 */
function get_masteries(?int $player_id = null): array {
